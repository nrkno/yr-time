...
exports.formatDay = function (date, daysFromNow, format, grammar) {
  if (daysFromNow < 2) {
    ...
    return daysFromNow == 1 ? grammar.tomorrow : hour >= exports.DAY_END || hour < exports.DAY_START ? grammar.tonight : grammar.today;
  }
...
function getDay(date) {
  ...
  return date.hour() < exports.DAY_START ? d.subtract(1, 'day') : d;
}